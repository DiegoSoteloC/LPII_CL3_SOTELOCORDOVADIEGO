...
public class ClassProductoImp implements IProducto {
	...
	public void RegistrarProducto(TblProductocl3 producto) {
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("LPII_CL3_SOTELOCORDOVADIEGO");
	...
	public void ActualizarProducto(TblProductocl3 producto) {
		EntityManagerFactory em=Persistence.createEntityManagerFactory("LPII_CL3_SOTELOCORDOVADIEGO");
	...
	public TblProductocl3 BuscarProducto(TblProductocl3 producto) {
		EntityManagerFactory fabr=Persistence.createEntityManagerFactory("LPII_CL3_SOTELOCORDOVADIEGO");
